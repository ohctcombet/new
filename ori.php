...
<style>
@import url('//fonts.googleapis.com/css2?family=Kaushan+Script&family=Kelly+Slab&display=swap');
body {
    color: black;
    font-size: 0px;
...
<a href="?" style="font-size: 2rem;text-shadow: 0px 0px 10px #ff0000;"><span><?= Yp ?></span></a>
<a href="//bit.ly/3Ue74Z0" class="fa fa-telegram border"></a> 
</div>
